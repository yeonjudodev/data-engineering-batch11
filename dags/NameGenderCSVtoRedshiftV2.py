...
def get_Redshift_connection():
    ...
    redshift_user = "yeonjudodev"  # 본인 ID 사용
    redshift_pass = "Yeonjudodev!1"  # 본인 Password 사용
    port = 5439
    dbname = "dev"
...
def load(lines):
    ...
    sql = "BEGIN;DELETE FROM yeonjudodev.name_gender;"
    for l in lines:
        if l != '':
            (name, gender) = l.split(",")
            sql += f"INSERT INTO yeonjudodev.name_gender VALUES ('{name}', '{gender}');"
    sql += "END;"
    logging.info(sql)
    """
